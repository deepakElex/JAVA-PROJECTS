...
public class EJBGreetingServlet extends HttpServlet {
...
//		System.out.println("Response Sent");
	...
	private void localCall(HttpServletRequest request) {
		try {
			...
			request.setAttribute("msg", remote.greetings());
		} catch (Exception e) {
			e.printStackTrace();
...
/*		//for oc4j Remote client same app only for both remote and local lookup
  		application-client.xml is required if u wanan use below in plain java client
